...
temp = input("Введите номер задания: ")
match temp:
    case '1':
        temperature = int(input("Задание №1\nВведите температуру воздуха на улице: "))
        humidity = int(input("Введите влажность воздуха на улице: "))
        weather = input("Введите погоду на улице: ")
        print(f"Температура на улице: {temperature} градуса\nВлажность воздуха {humidity}%\nПогода за окном: {weather}")
    case '2':
        firstNumber = float(input("Задание №2\nВведите первое число: "))
        secondNumber = float(input("Введите второе число: "))
        print(f"Результат сложения: {firstNumber+secondNumber}")
        print(f"Результат вычитания: {firstNumber-secondNumber}")
        print(f"Результат умножения: {firstNumber*secondNumber}")
        print(f"Результат деления: {firstNumber/secondNumber}")
        print(f"Результат остатка от деления: {firstNumber%secondNumber}")
        print(f"Результат деления нацело: {firstNumber//secondNumber}")
        print(f"Результат степени: {firstNumber**secondNumber}")
    case '3':
        print("Задание №3")
